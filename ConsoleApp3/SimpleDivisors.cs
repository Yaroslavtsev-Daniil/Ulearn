...
namespace TrainingApps
{
    class SimpleDivisors
    {
        ...
        /// <summary>
        /// Ищет количество чисел меньших N, которые имеют простые делители X или Y
        /// </summary>
        ...
        public static void GetDivisors()
        {
            ...
            for (int i = start; i < n; i++)
            {
                ...
                if (divX == 0 || divY == 0)//Если хотя бы один делит число без остатка, то
                {
                    divisors.Add(i);
                }
            }
